...
var zh = {
  ...
  sshNavGroup: "SSH \u8FDC\u7A0B",
  sshEmpty: "\u5C1A\u672A\u6DFB\u52A0\u4E3B\u673A\uFF08\u70B9\u300C\u65B0\u5EFA \u25BE\u300D\u2192 \u6DFB\u52A0 SSH \u4E3B\u673A\uFF09",
  viewLarge: "\u5927\u56FE\u6807",
  viewMedium: "\u4E2D\u7B49\u56FE\u6807",
  viewSmall: "\u5C0F\u56FE\u6807",
  viewList: "\u5217\u8868",
...
var en = {
  ...
  sshEmpty: "No hosts yet \u2014 click \u201CNew \u25BE \u2192 Add SSH Host\u201D",
...
function WorkbenchGlyph({ size = 16, className }) {
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("svg", { width: size, height: size, viewBox: "0 0 16 16", fill: "none", "aria-hidden": "true", className, children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("rect", { x: "1.9", y: "2.9", width: "12.2", height: "10.2", rx: "1.6", stroke: "currentColor", strokeWidth: "1.3" }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "M 6.2 2.9 V 13.1", stroke: "currentColor", strokeWidth: "1.3" }),
...
function VSCodeGlyph({ size = 16, className }) {
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("svg", { width: size, height: size, viewBox: "0 0 16 16", fill: "none", "aria-hidden": "true", className, children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("rect", { x: "1.7", y: "2.6", width: "12.6", height: "10.8", rx: "1.4", stroke: "currentColor", strokeWidth: "1.3" }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "M 5.1 2.6 V 13.4", stroke: "currentColor", strokeWidth: "1.3" }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "M 7 6.2 h 5.6 M 7 8.2 h 5.6 M 7 10.2 h 3.8", stroke: "currentColor", strokeWidth: "1.1", strokeLinecap: "round" })
  ] });
}
function apply(ctx) {
  ...
  if (!document.querySelector(`link[href="${apiBase2}/${"assets/style-PnATKHWZ.css"}"]`)) {
    const link = document.createElement("link");
    link.rel = "stylesheet";
    link.href = `${apiBase2}/${"assets/style-PnATKHWZ.css"}`;
    document.head.appendChild(link);
  }
  if (!document.querySelector(`script[src="${apiBase2}/${"assets/index-7mcIvrGl.js"}"]`)) {
    const script = document.createElement("script");
    script.type = "module";
    script.src = `${apiBase2}/${"assets/index-7mcIvrGl.js"}`;

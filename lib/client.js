...
function apply(ctx) {
  ...
  if (!document.querySelector(`link[href="${apiBase2}/${"assets/style-jISPkxrA.css"}"]`)) {
    const link = document.createElement("link");
    link.rel = "stylesheet";
    link.href = `${apiBase2}/${"assets/style-jISPkxrA.css"}`;
    document.head.appendChild(link);
  }
  if (!document.querySelector(`script[src="${apiBase2}/${"assets/index-BVQhKxGF.js"}"]`)) {
    const script = document.createElement("script");
    script.type = "module";
    script.src = `${apiBase2}/${"assets/index-BVQhKxGF.js"}`;

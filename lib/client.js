...
function apply(ctx) {
  ...
  if (!document.querySelector(`link[href="${apiBase2}/${"assets/style-B5clt5j7.css"}"]`)) {
    const link = document.createElement("link");
    link.rel = "stylesheet";
    link.href = `${apiBase2}/${"assets/style-B5clt5j7.css"}`;
    document.head.appendChild(link);
  }
  if (!document.querySelector(`script[src="${apiBase2}/${"assets/index-PYqqi0Fg.js"}"]`)) {
    const script = document.createElement("script");
    script.type = "module";
    script.src = `${apiBase2}/${"assets/index-PYqqi0Fg.js"}`;

...
function apply(ctx) {
  ...
  if (!document.querySelector(`link[href="${apiBase}/${"assets/style-B_h8UCgo.css"}"]`)) {
    const link = document.createElement("link");
    link.rel = "stylesheet";
    link.href = `${apiBase}/${"assets/style-B_h8UCgo.css"}`;
    document.head.appendChild(link);
  }
  if (!document.querySelector(`script[src="${apiBase}/${"assets/index-CoSes9zV.js"}"]`)) {
    const script = document.createElement("script");
    script.type = "module";
    script.src = `${apiBase}/${"assets/index-CoSes9zV.js"}`;

...
var zh = {
  ...
  termOfficialFailed: "\u5B98\u65B9\u7EC8\u7AEF\u542F\u52A8\u5931\u8D25\uFF1A{msg}",
  termOfficialRetry: "\u91CD\u8BD5",
...
var en = {
  ...
  termOfficialFailed: "Official terminal failed to start: {msg}",
  termOfficialRetry: "Retry",
...
function apply(ctx) {
  ...
  if (!document.querySelector(`link[href="${apiBase2}/${"assets/style-CqBpKI1e.css"}"]`)) {
    const link = document.createElement("link");
    link.rel = "stylesheet";
    link.href = `${apiBase2}/${"assets/style-CqBpKI1e.css"}`;
    document.head.appendChild(link);
  }
  if (!document.querySelector(`script[src="${apiBase2}/${"assets/index-CcScx_gp.js"}"]`)) {
    const script = document.createElement("script");
    script.type = "module";
    script.src = `${apiBase2}/${"assets/index-CcScx_gp.js"}`;

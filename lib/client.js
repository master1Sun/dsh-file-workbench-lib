...
function InlineChevronDown({ size = 14, className }) {
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("svg", { width: size, height: size, viewBox: "0 0 16 16", fill: "none", "aria-hidden": "true", className, children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
    "path",
    {
...
function resolveChevronDown() {
  const bag = UiPrimitives;
  for (const name of [
...
var GuideCardBoundary = class extends import_react3.Component {
  state = { failed: false };
...
function createGuideCard(deps) {
  return function GuideCard({ kind, description, useTabInfo }) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
      GuideCardBoundary,
      {
        fallback: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
          "button",
          {
            type: "button",
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "dshfw-guideIcon", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Icon, { size: 22 }) }),
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dshfw-guideCard", "data-sidebar-right-guide-entry": kind, children: [
            ...
            import_dsh_client_ui_primitives.Menu,
            {
              ...
              anchor: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
                import_dsh_client_ui_primitives.Button,
                {
                  ...
                  children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(ChevronDown, {})
                }
              )
            }
          )
...
function apply(ctx) {
  ...
  if (!document.querySelector(`link[href="${apiBase2}/${"assets/style-XRKgxIgu.css"}"]`)) {
    const link = document.createElement("link");
    link.rel = "stylesheet";
    link.href = `${apiBase2}/${"assets/style-XRKgxIgu.css"}`;
    document.head.appendChild(link);
  }
  if (!document.querySelector(`script[src="${apiBase2}/${"assets/index-hd_o6Nxg.js"}"]`)) {
    const script = document.createElement("script");
    script.type = "module";
    script.src = `${apiBase2}/${"assets/index-hd_o6Nxg.js"}`;

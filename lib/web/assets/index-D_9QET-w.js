...
`},{id:"bookmarks",name:"书签",version:"",description:"切换光标行书签、按项目持久化并点击跳转（gutter 圆点标记）",nameEn:"Bookmarks",descriptionEn:"DSH file editor plugin: activity bar view that toggles line bookmarks, lists current/all-project bookmarks and jumps to them. Uses v5.1 ctx.editor.createDecorations(category:bookmark) gutter marks + /persist per project. Counterpart of VS Code Bookmarks.",code:`window.__ModuleLoader__.load({
	id: "dsh-fw.bookmarks",
	factory: (require) => {
		/**

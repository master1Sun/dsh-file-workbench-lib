window.__ModuleLoader__.manifest({"id":"dsh-fw._skeleton","name":"<中文名>","version":"","description":"<中文一句话描述>","nameEn":"Plugin Skeleton","descriptionEn":"DSH file editor plugin: <英文描述>. Counterpart of VS Code <对标插件>."});

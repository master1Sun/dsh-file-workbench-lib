window.__ModuleLoader__.manifest({"id":"dsh-fw.project-stats","name":"项目统计","version":"","description":"一键统计当前项目的文件数、每个文件行数与总字节数，结果可在详情表格里点击查看","nameEn":"Project Stats","descriptionEn":"One-click project statistics: file count, per-file line counts and total bytes. Runs from the bottom Extensions menu, renders a sortable detail table, and remembers the last result per project."});
window.__ModuleLoader__.load({
	id: "dsh-fw.project-stats",
	inject: [],
	factory: (require) => {
		/**

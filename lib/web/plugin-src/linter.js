window.__ModuleLoader__.manifest({"id":"dsh-fw.linter","name":"外部诊断","version":"","description":"运行可配置 lint/tsc/node 命令，把诊断标成波浪线并列成可跳转问题面板","nameEn":"External Linter","descriptionEn":"DSH file editor plugin: activity bar view that runs user-configured commands (node --check/tsc/eslint…) to capture diagnostics, parses file:line:col message → v1 createDecorations squiggles + a jumpable problems panel. Counterpart of VS Code Problems/External Linter."});

window.__ModuleLoader__.manifest({"id":"dsh-fw.md-preview","name":"Markdown 预览","version":"","description":"把当前 Markdown 缓冲实时渲染成 HTML 预览","nameEn":"Markdown Preview","descriptionEn":"DSH file editor plugin: activity bar view that live-renders the active Markdown buffer to HTML (dependency-free, escaped), based on the dsh-file-workbench-lib v1 injection API (window.__dshFileWorkbenchVSCode__)."});
